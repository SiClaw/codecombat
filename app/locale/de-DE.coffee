module.exports = nativeDescription: "Deutsch (Deutschland)", englishDescription: "German (Germany)", translation:
  ...
  new_home:
#    title: "CodeCombat - Programmiere um Python und JavaScript zu lernen"
#    meta_description: "Lerne geschriebenen Code durch ein Programmier-Spiel. Lerne Python, JavaScript, und HTML während du Puzzles löst und so deine eigenen Games und Webseiten kreierst."
#    built_for_teachers_title: "Ein Programmier-Spiel für Lehrer"
#    built_for_teachers_blurb: "Kindern das Programmieren beizubringen kann sehr überwältigend sein. CodeCombat hilft allen Lehrkräften ihren Schülern das Programmieren in JavaScript oder Python, zwei der bekanntesten Programiersprachen, beizubringen. With a comprehensive curriculum that includes six computer science units and reinforces learning through project-based game development and web development units, kids will progress on a journey from basic syntax to recursion!"
...
#    built_for_teachers_subblurb2: "Lernende konstruieren Labyrinthe und benutzen Basis Input um ihre eigenen Spiele zu erstellen, um sie dann mit Freunden und Familie zu teilen."
...
#    century_skills_title: "21 Century Skills"
#    century_skills_blurb1: "Schüler leveln nicht nur ihren Helden, sie leveln sich auch selbst."
#    century_skills_quote1: "Du hast es versaut…also denkst du über alle möglichen Wege nach es wieder in Ordnung zu bringen, dann versuchst du es nochmal. Ich wäre nicht so weit gekommen, wenn ich es nicht auf die harte Tour gelernt hätte."
#    century_skills_subtitle1: "Kritisches Denken"
...
#    century_skills_subtitle3: "Kollaboration"
